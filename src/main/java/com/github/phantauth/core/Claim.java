...
public enum Claim {
     ...
     **/
    GIVEN_NAME(Property.GIVEN_NAME),
     ...
     **/
    MIDDLE_NAME(Property.MIDDLE_NAME),
     ...
     **/
    PREFERRED_USERNAME(Property.PREFERRED_USERNAME),
     ...
     **/
    EMAIL_VERIFIED(Property.EMAIL_VERIFIED),
     ...
     * E.164 [E.164] is RECOMMENDED as the format of this Claim, for example, +1 (425) 555-1212 or +56 (2) 687 2400. If the phone number contains an extension, it is RECOMMENDED that the extension be represented using the RFC 3966 [RFC3966] extension syntax, for example, +1 (604) 555-1234;ext=5678.
     **/
     ...
     **/
    PHONE_NUMBER_VERIFIED(Property.PHONE_NUMBER_VERIFIED),
     ...
     * Users are identified by a URL. Profile URLs MUST have either an https or http scheme, MUST contain a path component
     * (/ is a valid path), MUST NOT contain single-dot or double-dot path segments, MAY contain a query string component,
     * MUST NOT contain a fragment component, MUST NOT contain a username or password component, and MUST NOT contain a port.
