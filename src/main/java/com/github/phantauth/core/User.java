...
public interface User {
     ...
     * @return givenName
     **/
    @JsonProperty(Property.GIVEN_NAME)
     ...
     * @return familyName
     **/
    @JsonProperty(Property.FAMILY_NAME)
     ...
     * @return middleName
     **/
    @JsonProperty(Property.MIDDLE_NAME)
     ...
     * @return nickname
     **/
    @JsonProperty(Property.NICKNAME)
     ...
     **/
    @JsonProperty(Property.PREFERRED_USERNAME)
     ...
     **/
    @JsonProperty(Property.EMAIL_VERIFIED)
     ...
     * @return birthdate
     **/
    @JsonProperty(Property.BIRTHDATE)
     ...
     * @return zoneinfo
     **/
    @JsonProperty(Property.ZONEINFO)
     ...
     * @return phoneNumber
     **/
    @JsonProperty(Property.PHONE_NUMBER)
     ...
     **/
    @JsonProperty(Property.PHONE_NUMBER_VERIFIED)
     ...
     * @return updatedAt
     **/
    @JsonProperty(Property.UPDATED_AT)
    ...
    @JsonProperty(Property.WEBMAIL)
    @JsonView(Views.Phantom.class)
    String getWebmail();

    @JsonProperty(Property.UID)
    @JsonView(Views.Phantom.class)
    @Value.Derived
    default String getUid() {
        final String value = getSub();

        return value == null ? null : Base64.getEncoder().withoutPadding().encodeToString(Hashing.farmHashFingerprint64().hashString(value, StandardCharsets.UTF_8).asBytes());
    }

    class Builder extends UserValue.BuilderBase {
    }
}
